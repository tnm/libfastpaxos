...
/* 
    ...
    in milliseconds
*/
#define LEARNER_LSYNC_INTERVAL 100
...
*/
#define PROPOSER_PREEXEC_WIN_SIZE 256
...
*/
#define ACCEPTOR_ARRAY_SIZE 2048
...
/* 
   ...
   IMPORTANT: This must be a power of 2
*/
#define LEARNER_ARRAY_SIZE 1024
...
/* 
   ...
   IMPORTANT: This must be a power of 2
*/
#define PROPOSER_ARRAY_SIZE 1024
